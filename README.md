...
sequenceDiagram
    ...
    participant UI as Konsole / UI
    participant Game as Game (Logik)
    participant History as History
    participant Board as Spielfeld (Array)
    ...
    Note right of Game: Memento: Zustand vor<br/>Änderung speichern
